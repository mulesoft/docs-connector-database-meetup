...
The connector also provides insert, update and delete operations. Just like the xref:db-connector-query.adoc[select operation], these operations support dynamism and parameterization by using embedded DataWeave transformations:
